...
public class SMSUtils {
	public static String sendMessage(HttpServletRequest request, String phoneNumber) {
		String reStr = ""; //定义返回值
		// 短信应用SDK AppID  1400开头
		int appid = 1400718300;
		// 短信应用SDK AppKey
		String appkey = "edf4683b9b72d756f63dfbac33c09d04";
		// 短信模板ID，需要在短信应用中申请
		int templateId =1502021;
		// 签名，使用的是签名内容，而不是签名ID
		String smsSign = "test测试短信公众号";
		//随机生成四位验证码的工具类
